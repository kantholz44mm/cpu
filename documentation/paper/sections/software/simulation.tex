...
The full simulation contains 2041 individual 2-input \texttt{NAND} gates. An overview of the simulation can be seen in \appref{app:simulation_full}. \autoref{fig:implementation_simulation_gate_pie_chart} shows how the gates are distributed among the individual logical modules.
