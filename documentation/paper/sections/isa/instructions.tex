...
\begin{table}[H]
    ...
    \end{tabular}    
\end{table}
\caption{Effect of instruction suffix on arithmetic instructions (XXX represents an arbitrary arithmetic operation)}
...
\begin{table}[H]
    ...
    \end{tabular}
\end{table}
\caption{Supported instructions and their opcodes, variants, type and brief description (variant suffices are explained in \autoref{tab:instruction_suffices})}
...
\begin{figure}[h!]
    ...
    \caption{\ac{ava} 32 bit instruction encoding scheme and field descriptions. Numbers above fields represent bit positions within the instruction}
