...
\begin{figure}[h!]
    ...
    \caption[Implemented addressing modes]{Hierarchical overview of addressing modes with implemented modes highlighted. (Modified from S. Dandamudi, laid out horizontally and compacted for readability \cite{sivarama_addrmodes})}
