...
\begin{minipage}[t]{\textwidth}
    ...
    \captionof{table}{Registers used in the AVA ISA}
\end{minipage}
...
The \ac{ava} \ac{isa} defines the lower half of its 16 bit memory space to be working memory, while the content and mapping of the upper half is left to the user. This way, memory mapped \ac{io} can be used to either add more memory or specific peripherals such as \ac{gpio}, an \ac{adc} or similar devices. This allows the device to be extended in a way that best fits the current application.