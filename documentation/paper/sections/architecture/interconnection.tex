...
\begin{figure}[h!]
    ...
    \caption{Datapath of an implementation of the AVA \ac{isa}. Solid black lines transport data, dotted red lines are control signals. Clock signals and external interfaces are omitted for clarity.}
