...
\begin{figure}[H]
    ...
    \caption[Datapath of instruction decoding]{Datapath of instruction decoding. Solid black lines transport data, dotted red lines are control signals}
...
\begin{figure}[H]
    ...
    \caption[Datapath of instruction decoding and ALU]{Datapath of instruction decoding and ALU. Solid black lines transport data, dotted red lines are control signals}
...
\begin{figure}[H]
    ...
    \caption[Datapath of instruction decoding, ALU and PC]{Datapath instruction decoding, ALU and program counter. Solid black lines transport data, dotted red lines are control signals}
...
\begin{figure}[H]
    ...
    \caption[Datapath of an AVA implementation]{Datapath of an implementation of the \ac{ava} \ac{isa}. Solid black lines transport data, dotted red lines are control signals. Clock signals and external interfaces are omitted for clarity.}
