\subsection{Modularisation} \label{sec:architecture_modularisation}
...
\begin{table}[H]
    ...
    \begin{tabular}{|l|l|l|} 
        ...
        \hline
    \end{tabular}
    \caption{Input and output signals of the branch control unit}
...
\begin{table}[H]
    ...
    \begin{tabular}{|l|l|l|} 
        ...
        \hline
    \end{tabular}
    \caption{Input and output signals of the Arithmetic logic unit}
...
\begin{table}[H]
    ...
    \begin{tabular}{|l|l|l|} 
        ...
        \hline
    \end{tabular}
    \caption[Input and output signals of a memory]{Input and output signals of a memory unit. Only working memory requires read-enable, write-enable and clock lines.}
...
\begin{table}[H]
    ...
    \begin{tabular}{|l|l|l|} 
        ...
        \hline
    \end{tabular}
    \caption{Input and output signals of an individual register}
...
\begin{table}[H]
    ...
    \begin{tabular}{|l|l|l|} 
        ...
        \hline
    \end{tabular}
    \caption{Input and output signals of the register file}
