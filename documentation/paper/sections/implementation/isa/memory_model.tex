...
\begin{table}
    ...
    \begin{tabular}{|c|c|c|l|} 
        ...
        \hline
        2                       & C                     & Carry/Borrow  & \begin{tabular}[c]{@{}l@{}}Set when the result of an addition or subtraction of two\\unsigned numbers does not fit into an unsigned number\\or when a bit shifting instruction shifts out a 1\end{tabular}  \\ 
        \hline
        3                       & V                     & Overflow      & \begin{tabular}[c]{@{}l@{}}Set when the result of an addition or subtraction of two\\signed numbers does not fit into a signed number\end{tabular}                                                          \\
        \hline
    \end{tabular}
    \label{tab:implementation_alu_flags}
    \captionof{table}{Set of flags output by each arithmetic operation}
\end{table}
